...
public class ClienteConexao {
    ...
    public void ouvirMensagem(ClienteGUI gui) {
        new Thread(() -> {
            try (BufferedReader br = new BufferedReader(new InputStreamReader(socket.getInputStream()))) {
                // Lê as mensagens recebidas do servidor em um loop.
                String mensagemRecebida;
                while ((mensagemRecebida = br.readLine()) != null) {
                    // Adiciona a mensagem recebida à interface gráfica.
    ...
    public void desconectar() {
        try {
            ...
            // Exibe uma mensagem de erro caso não seja possível desconectar.
